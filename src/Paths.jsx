      ...
      <div className=" w-full lg:w-1/2 h-screen bg-[#F8FAFF] flex flex-col justify-center items-center ">
        <div className="max-w-md lg:pl-5 w-full pr-10 mt-5">
          ...
          <div className="flex flex-row w-full space-x-3 px-5 lg:px-10  max-w-md mt-5 ">
            ...
            <div className="flex justify-center items-center rounded-lg w-full h-10 bg-white text-center px-5 text-nowrap lg:space-x-1 space-x-2">
              <AiFillApple className="text-gray-500" size={25} />
              <p className="text-sm">Sign-in with Apple</p>
            </div>
          </div>
          <div className="flex flex-col justify-around w-full h-fit items-start mr-5 px-4 lg:px-8 lg:py-7 bg-white m-8 lg:m-10 space-y-6 text-left rounded-xl">
          ...
          <div className="flex flex-col lg:flex-col justify-center items-center pl-10 text-gray-400">
